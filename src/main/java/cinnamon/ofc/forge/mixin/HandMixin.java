...
public abstract class HandMixin {
    ...
    public float getMainHandSwing(float partial) {
        RLOffHandCombatMod.Data data = RLOffHandCombatMod.get(Objects.requireNonNull(Minecraft.getInstance().player));
    ...
    public float getSwingProgress(RLOffHandCombatMod.Data data, float partialTickTime) {
